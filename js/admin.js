      ...
      orderedBatches.forEach((batchName, bIdx) => {
        ...
        tableHTML += `
          <div style="${pageBreak}margin-bottom:1.5rem;">
            <div style="display:flex;justify-content:space-between;align-items:center;background:#2D6A4F;color:#fff;padding:8px 14px;border-radius:6px 6px 0 0;font-family:'Inter',sans-serif;-webkit-print-color-adjust:exact;print-color-adjust:exact;">
        ...
        // Main table — All students in batch (Regular + Exited + Trustee)
        if (pending.length > 0) {
          tableHTML += `
          ...
          pending.forEach((e, i) => {
            ...
            tableHTML += `
                <tr style="background:${bg};">
                  ...
                  <td style="${tdStyleR}${e.arrears > 0 ? 'color:#dc2626;font-weight:600;' : ''}">${arrearsDisp}</td>
